    ...
    const createSingleMatchObject = (match, parsedData, username, website) => {
        ...
        */
        ...
        return {
            ...
            ,
            moves: {
                full:               parsedData.MoveObject
              , string:             parsedData.MoveString
              , white:              getPlayerMoves(parsedData.MoveObject, "white")
              , black:              getPlayerMoves(parsedData.MoveObject, "black")
              , first:              getStartingMove( getPlayerMoves(parsedData.MoveObject, "white") )
            }
            ,
            results: {
            ...
            playerResults: {
              ...
              , userPlayed:         userPlayed
              , userResult:         playerResult
              , userMoves:          getPlayerMoves(parsedData.MoveObject, userPlayed)
            }
            ,
            time: {
